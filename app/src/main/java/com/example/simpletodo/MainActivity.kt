...
loadItems()
       ...
       val recyclerView =  findViewById<RecyclerView>(R.id.recyclerView)
        ...
        // Get a reference to the buttton
        // and then set an onclicklistener
        findViewById<Button>(R.id.button).setOnClickListener {
            // Grab a text that a user has inputted into @+id/addTaskField"
    ...
    // Save data writing and reading from a file
    ...
    // Load then item by reading every line in the data file
    fun loadItems() {
        try {
